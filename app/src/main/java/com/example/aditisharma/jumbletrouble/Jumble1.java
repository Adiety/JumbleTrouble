...
public class Jumble1 extends AppCompatActivity {

    Button b1,b2,b3,b4,next,check,endGame;
    ImageButton clear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(gameCount == 11)
                {
                    Intent i = new Intent(Jumble1.this,Result1.class);
                    Bundle bundle = new Bundle();
                    bundle.putInt("scoreEasy",s);
                    bundle.putInt("J",1);
                    i.putExtras(bundle);
                    startActivity(i);
                }
    ...
    {
        currentWord = DataDemo.RealWord[r];
        ShuffleWord();
        r++;
        gameCount++;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mi.inflate(R.menu.jumble1menu,menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent i =new Intent(Jumble1.this,MainPage.class);
            startActivity(i);
        }
        else if (menu_id==R.id.omi2)
        {
            Intent i = new Intent(Jumble1.this,Jumble2.class);
            startActivity(i);
        }
        else if (menu_id==R.id.omi3)
        {
            Intent i = new Intent(Jumble1.this,Jumble3.class);
            startActivity(i);
        }
