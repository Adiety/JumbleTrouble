...
public class Jumble3 extends AppCompatActivity {

    Button b1,b2,b3,b4,b5,b6,next,check,endGame;
    ImageButton clear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jumble3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (gameCount == 11)
                {
                    Intent i = new Intent(Jumble3.this,Result1.class);
                    Bundle bundle = new Bundle();
                    bundle.putInt("scoreHard",s);
                    bundle.putInt("J",3);
                    i.putExtras(bundle);
                    startActivity(i);
                }
    ...
    {
        currentWord = DataDemo.sixletter[r];
        ShuffleWord();
        r++;
        gameCount++;
    ...
    private void ShuffleWord( )
    {
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tv1.append(b6.getText().toString());
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mi.inflate(R.menu.jumble3menu,menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent i =new Intent(Jumble3.this,MainPage.class);
            startActivity(i);

        }
        else if (menu_id==R.id.omi2)
        {
            Intent i = new Intent(Jumble3.this,Jumble1.class);
            startActivity(i);
        }
        else if (menu_id==R.id.omi3)
        {
            Intent i = new Intent(Jumble3.this,Jumble2.class);
            startActivity(i);
        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.omi5).setIcon(R.drawable.soundoff);
        return true;
    }
